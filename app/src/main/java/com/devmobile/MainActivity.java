...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(v -> {
            textView.setText(getString(R.string.click_count, i));
            i++;
        });
        ...
        //Configuration packege como origin para requests para osmdroid
        Configuration.getInstance().load(this, getSharedPreferences("osmdroid", MODE_PRIVATE));
        //inicialização do location manager
    ...
    public void initMap() {
        ...
        //deixa o usuário navegar pelo mapa tirando de centro
        map.setMultiTouchControls(true);
        //adciona um overlsay de escala
